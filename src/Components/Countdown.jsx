...
function Countdown() {
  ...
  const calculateTimeLeft = () => {
    const difference = +new Date("2024-12-19") - +new Date();
    let timeLeft = {};
  ...
  if (scrollPosition > posi) {
    return (
      <div className="fixed bottom-0 z-30 bg-pink_custom w-full flex flex-col justify-center items-center  textgap-2 py-2">
        <h2 className="font-merienda font-semibold text-2xl im-fell-english-sc-regular text-braun">
          Cuenta Regresiva
        </h2>
        <div className="text-xl flex justify-center gap-4 items-center bg-green_os w-11/12 py-2 text-braun divide-x-2 divide-pink_custom rounded-lg font-black">
          {timeLeft.days !== 0 && (
